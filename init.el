...
(cask-initialize)
(require 'pallet)
(add-to-list 'load-path "~/repo/emacs/helm/")
(add-to-list 'exec-path "~/repo/emacs/inf-ruby/inf-ruby.elc")

;(add-to-list 'load-path "./rvm-autoloads.el")
(add-to-list 'exec-path "/usr/local/bin")
(add-to-list 'load-path "~/repo/emacs/cider/")
(add-to-list 'load-path "~/repo/emacs/popwin-el/")
(add-to-list 'load-path "~/repo/smyx/")
(add-to-list 'load-path "~/repo/emacs/web-mode/")
;(add-to-list 'load-path "~/repo/emacs/smart-mode-line/") ;
(add-to-list 'load-path "~/repo/emacs/evil-eww-mode/evil-eww.el")
(add-to-list 'load-path "~/repo/emacs/rvm.el/rvm.elc")
(add-to-list 'load-path "~/repo/emacs/evil-jumper/")
(add-to-list 'load-path "~/repo/emacs/rainbow-mode/")
...
(defun inf-ruby-send-buffer ()
  (mark-whole-buffer)
  (inf-ruby-send-region))
...
(load "~/repo/emacs/evil-org-mode/evil-org.elc")
(load "~/.emacs.d/custom/smartparens-conf.el")
